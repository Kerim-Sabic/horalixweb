    ...
    match method {
        ...
        "describeNode" => {
                ...
                .or_else(|| params.get("backendNodeId").and_then(|v| v.as_u64()))
            {
                ...
                let code = format!(
                    "(function() {{ var o = globalThis.__horalix_objects['{}']; if (!o) return -1; return (typeof o._nid === 'number') ? o._nid : -1; }})()",
                    escaped_oid
                );
        ...
        "resolveNode" => {
                ...
                .or_else(|| params.get("backendNodeId").and_then(|v| v.as_u64()))
            {
                ...
                let code = format!(
                    "(function() {{ var o = globalThis.__horalix_objects['{}']; return (o && typeof o._nid === 'number') ? o._nid : -1; }})()",
                    oid
                );
                let result = page.evaluate(&code);
                result.as_f64().map(|n| n as u64).unwrap_or(0)
