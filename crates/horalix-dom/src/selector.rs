...
pub struct HoralixSelector;

impl parser::SelectorImpl for HoralixSelector {
...
pub struct HoralixSelectorParser;

impl<'i> parser::Parser<'i> for HoralixSelectorParser {
    type Impl = HoralixSelector;
...
pub fn parse_selector(selector: &str) -> Result<SelectorList<HoralixSelector>, String> {
    let mut parser_input = cssparser::ParserInput::new(selector);
    let mut parser = cssparser::Parser::new(&mut parser_input);
    SelectorList::parse(&HoralixSelectorParser, &mut parser, ParseRelative::No)
